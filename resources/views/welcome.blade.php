...
<body>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-7 col-md-12">
                    <small
                        ...
                        Coffee</small>
                    <h1 class="display-1 mb-4 animated bounceInDown">Selamat Datang<span
                            class="text-primary">Sunda</span>Coffee
                        Silahkan Di Pesan
                    </h1>
                    {{-- <a href="" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Book
                        Now</a> --}}
                    {{-- <a href=""
                ...
                <div class="col-lg-5 col-md-12">
                    <img src="auth/images/logos/sundacoffee.png" class="img-fluid rounded animated zoomIn" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                    <img src="index/img/about.jpg" class="img-fluid rounded" alt="">
                </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-1.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                                <a href="index/img/event-1.jpg" data-lightbox="event-1"
                                                    class="my-auto"><i
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.3s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-2.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Corporate</h4>
                                                <a href="index/img/event-2.jpg" data-lightbox="event-2"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.5s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-3.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                                <a href="index/img/event-3.jpg" data-lightbox="event-3"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.7s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-4.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Buffet</h4>
                                                <a href="index/img/event-4.jpg" data-lightbox="event-4"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-5.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Cocktail</h4>
                                                <a href="index/img/event-5.jpg" data-lightbox="event-5"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.3s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-6.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                                <a href="index/img/event-6.jpg" data-lightbox="event-6"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.5s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-7.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Buffet</h4>
                                                <a href="index/img/event-7.jpg" data-lightbox="event-7"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.7s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100" src="index/img/event-8.jpg"
                                                alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Corporate</h4>
                                                <a href="index/img/event-8.jpg" data-lightbox="event-17"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-8" class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-9" class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Corporate</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-10"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Corporate</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-11"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Cocktail</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-12"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Cocktail</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-13"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Buffet</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-14"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <div class="event-img position-relative">
                                            ...
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Buffet</h4>
                                                <a href="index/img/01.jpg" data-lightbox="event-15"
                                                    class="my-auto"><i
                                                        class="fas fa-search-plus text-dark fa-2x"></i></a>
                                            </div>
                                        </div>
                ...
                <div class="tab-class text-center">
                    <ul class="nav nav-pills d-inline-flex justify-content-center mb-5 wow bounceInUp" data-wow-delay="0.1s">
                        <li class="nav-item p-2">
                            <a class="d-flex py-2 mx-2 border border-primary bg-white rounded-pill active" data-bs-toggle="pill"
                                href="#tab-6">
                                <span class="text-dark" style="width: 150px;">Makanan Berat</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                        ...
                        <li class="nav-item p-2">
                            <a class="d-flex py-2 mx-2 border border-primary bg-white rounded-pill" data-bs-toggle="pill"
                                href="#tab-8">
                                <span class="text-dark" style="width: 150px;">Cemilan</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="d-flex py-2 mx-2 border border-primary bg-white rounded-pill" data-bs-toggle="pill"
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-6" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                                @if ($makananutama)
                                    @foreach ($makananutama as $menu)
                                        <div class="col-lg-4 col-md-6 mb-4 wow bounceInUp" data-wow-delay="0.2s">
                                            <div class="menu-item d-flex align-items-center">
                                                <img class="img-fluid rounded wow bounceInUp" data-wow-delay="0.2s"
                                                    src="{{ url('../storage/menu/' . $menu->foto) }}" alt=""
                                                    style="width: 150px; height: 150px; object-fit: cover;">
                                                <div class="w-100 d-flex flex-column text-start ms-3 wow bounceInUp"
                                                    data-wow-delay="0.3s">
                                                    <div class="d-flex justify-content-between border-bottom border-primary pb-2 mb-2">
                                                        <h4 class="mb-0 wow bounceInUp" data-wow-delay="0.4s">{{ $menu->nama_menu }}</h4>
                                                        <h4 class="mb-0 text-primary wow bounceInUp" data-wow-delay="0.4s">Rp. {{ $menu->harga }}</h4>
                                                    </div>
                                                    <p class="mb-0 wow bounceInUp" data-wow-delay="0.5s">{{ $menu->deskripsi }}</p>
                                                </div>
                                            </div>
                                            <form action="{{ route('tambah') }}" method="POST" class="mt-3 wow bounceInUp"
                                                data-wow-delay="0.6s">
                                                @csrf
                        ...
                        <div id="tab-7" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                @if ($makananpenutup)
                                    @foreach ($makananpenutup as $menu)
                                        <div class="col-lg-4 col-md-6 mb-4 wow bounceInUp" data-wow-delay="0.2s">
                                            <div class="menu-item d-flex align-items-center">
                                                <img class="img-fluid rounded wow bounceInUp" data-wow-delay="0.2s"
                                                    src="{{ url('../storage/menu/' . $menu->foto) }}" alt=""
    ...
    {{-- <section id="reservasi">
        <div class="container-fluid contact py-6 wow bounceInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="row g-0">
                    <div class="col-1">
                        <img src="index/img/background-site.jpg" class="img-fluid h-100 w-100 rounded-start"
                    ...
                    <div class="col-10">
                        <div class="border-bottom border-top border-primary bg-light py-5 px-4">
                            <div class="text-center">
                                <small
                                    class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Pesan
                                    Kami</small>
                                <h1 class="display-5 mb-5">Dimana Anda Ingin Menggunakan Layanan Kami</h1>
                            </div>
    ...
    <div class="row g-4 form">
        ...
        <div class="col-lg-4 col-md-6">
            <select class="form-select border-primary p-2" aria-label="Default select example">
                ...
                <option value="1">Berdasarkan Negara</option>
                <option value="2">UK</option>
                <option value="3">India</option>
            </select>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <select class="form-select border-primary p-2" aria-label="Default select example">
                <option selected>Acara Kecil</option>
                <option value="1">Tipe Acara</option>
                <option value="2">Acara Besar</option>
                <option value="3">Acara Kecil</option>
            </select>
        </div>
        <div class="col-lg-4 col-md-6">
            <select class="form-select border-primary p-2" aria-label="Default select example">
                <option selected>Jumlah Tempat</option>
        ...
        <div class="col-lg-4 col-md-6">
            <input type="tel" class="form-control border-primary p-2" placeholder="Nomor Kontak Anda">
        </div>
        <div class="col-lg-4 col-md-6">
            <input type="datetime-local" class="form-control border-primary p-2" placeholder="Pilih Tanggal">
        </div>
        <div class="col-lg-4 col-md-6">
            <input type="email" class="form-control border-primary p-2" placeholder="Masukkan Email Anda">
        </div>
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill">Kirim
                Sekarang</button>
        </div>
    </div>
    </form>
    ...
    <div class="col-1">
        <img src="index/img/background-site.jpg" class="img-fluid h-100 w-100 rounded-end" style="object-fit: cover; opacity: 0.7;" alt="">
    </div>
    </div>
    </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded">
                        <img class="img-fluid rounded-top " src="index/img/team-1.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded">
                        <img class="img-fluid rounded-top " src="index/img/team-2.jpg" alt="">
                        <div class="team-content text-center py-3 bg-dark rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded">
                        <img class="img-fluid rounded-top " src="index/img/team-3.jpg" alt="">
                        <div class="team-content text-center py-3 bg-dark rounded-bottom">
                ...
                <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.7s">
                    <div class="team-item rounded">
                        <img class="img-fluid rounded-top " src="index/img/team-4.jpg" alt="">
                        <div class="team-content text-center py-3 bg-dark rounded-bottom">
                        ...
                        @foreach ($rating as $data)
                            <div class="testimonial-item rounded bg-light">
                                <div class="d-flex mb-3">
                                    <!-- If no image, just omit the image element -->
                                    <div class="position-absolute" style="top: 15px; right: 20px;">
                                        <i class="fa fa-quote-right fa-2x"></i>
                                    </div>
                                    <div class="ps-3 my-auto">
                                        <h4 class="mb-0">{{ $data->name }}</h4>
                                        {{-- <p class="m-0">{{ $data->profession }}</p> --}}
                                    </div>
                                </div>
                                <div class="testimonial-content">
                                    ...
                                    <p class="fs-5 m-0 pt-3">{{ $data->ulasan }}</p>
                                </div>
                            </div>
                        @endforeach
                    @endif
        ...
        <div class="container">
            ...
            <div class="row gx-4 justify-content-center">
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <img src="index/img/blog-1.jpg" class="img-fluid w-100" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <img src="index/img/blog-2.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <img src="index/img/blog-3.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="lh-lg mb-4">
                                Sunda Coffee, didirikan pada 2016 di Gunung Sunda, Sukabumi, memperkenalkan kopi lokal dengan metode seduh manual.
                                Dikenal karena konsep outdoor, kedai ini resmi beroperasi pada 12 November 2016. Pada 28 Desember 2018, mereka membuka cabang baru, Sunda Coffee and Space, di Jl. Cikole Dalam, Kota Sukabumi.
                            </p>
                            <div class="footer-icon d-flex">
                                {{-- <a class="btn btn-primary btn-sm-square me-2 rounded-circle" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-primary btn-sm-square me-2 rounded-circle" href="#"><i class="fab fa-twitter"></i></a> --}}
                                <a class="btn btn-primary btn-sm-square me-2 rounded-circle" href="https://www.instagram.com/sundacoffee/"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Memiliki bar - Wi-Fi</a>
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Tempat duduk di area terbuka</a>
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Musik live</a>
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Kursi khusus pengguna kursi roda</a>
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Pintu masuk khusus pengguna kursi roda</a>
                                <a class="text-body mb-3" href="#"><i class="fa fa-check text-primary me-2"></i>Toilet khusus pengguna kursi roda</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <p><i class="fa fa-map-marker-alt text-primary me-2"></i>Jl. Cikole Dalam No.38, Cikole, Kec. Cikole, Kota Sukabumi, Jawa Barat 43113</p>
